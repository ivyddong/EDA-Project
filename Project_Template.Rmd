...
> Hypothesis A: Water availability decreased in the last 5 years for the Navajo Nation.
...
> Hypothesis B: The water quality in the Colorado River before and after passing through the Navajo Nation is significantly different.

> RQ 3: How has the water quality changed in the Colorado River in the last 5 years?
> Hypothesis C: The water quality in the Colorado River before and after passing through the Navajo Nation has changed significantly in the last 5 years.
...
```{r Dataset structure table quality, echo=FALSE, include=FALSE}
...
```{r Dataset structure table quantity, echo=FALSE, include=FALSE}
...
In terms of water availability, the discharge volume for both the San Juan and Colorado Rivers has declined over the last five years, with an average of xxx in 2019 and xxx in 2024, representing a decrease of xxx over the five-year period. This result is corroborated by previous years' droughts that have affected the water quantity in the reservation.

In comparison, it was estimated that a section of the Navajo Nation could be using 11,538,380 gallons/year from the Colorado River and 47,850,040 gallons/year from the San Juan River for domestic use only. The water availability is sufficient if it were only used for household consumption, but since most of the water extracted from the rivers is for agricultural purposes, it ends up being limited. As mentioned before, the average water used for agriculture by the Lower Basin from 2000 to 2019 is 6,610.06 million cubic meters, which is 1,746,193,109,029.7864 gallons.

Based on the analysis of element concentrations, the water quality of the Colorado River meets good standards for human use. Its concentration when entering the tribal territory is relatively low compared to maximum human health standards. However, it is necessary to conduct a broader evaluation of other elements and contaminant concentrations in the water to identify if there are additional components that could deteriorate the water quality for Navajo activities such as agriculture, consumption, and others. Data availability was limited for the present document analysis in terms of the time period and the station's measurements. On the other hand, the water quality leaving the reserve for most of the time periods of the three elements is significantly higher than when entering, indicating that there are activities in the territory that contribute to the concentration of those elements in the water.
