...
There is no missing data so it is not necessary to execute linear interpolation for time series analysis. 
...
*Note to Samantha: when explaining our methods I think we need to make clear this assumption. we're counting only populations right beside the river, even though with water transport infrastructure, people in chapters far from the river will also be withdrawing, so this estimate of water withdrawing is an underestiamte.  
