...
Mean annual Magnesium concentrations increased on the Colorado river (Figure 6) from 2020-2023, having a low concentration on 2018 and high increase in 2019 up to 22.9 mg/L. 
...
```{r Data visualization Magnesium t-test, echo=FALSE}
#t-test
...
```{r Data visualization Uranium t-test, echo=FALSE}
#t-test
