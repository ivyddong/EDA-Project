...
=======
#Merged Datasets respectively
>>>>>>> 674f3250fe98d71d6e488a43b7ccc0d976faee6a
...
Mean annual Uranium concentrations increased on the Colorado river (see Figure 5) from 2019-2024, nevertheless, the concentrations have not yet exceed a concerning level for human health according to the recommended maximum levels for drinking water by The World Health Organization and the EPA, however the goal concentrations are zero (World Health Organization, 2009; US EPA, 2024). Considering that the water used from Colorado river is for direct human consume and other activities, accumulation of this element can potentially generate a radiological toxicity and high concentrations of that cummulation can generate impacts on human health such as kidney deseases (Vengosh, 2024). The low concentrations of this component at this location is remarkable considering the historical mining in the Navajo territories. ()  
